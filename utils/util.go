...
func RandomName() string {
	firstName := []string{"迷你的", "鲜艳的", "飞快的", "真实的", "清新的", "幸福的", "可耐的", "快乐的", "冷静的", "醉熏的", "潇洒的", "糊涂的", "积极的", "冷酷的", "深情的", "粗暴的",
		...
		"还单身的", "怕孤单的", "懵懂的"}
	secondName := []string{"嚓茶", "皮皮虾", "皮卡丘", "马里奥", "小霸王", "凉面", "便当", "毛豆", "花生", "可乐", "灯泡", "哈密瓜", "野狼", "背包", "眼神", "缘分", "雪碧", "人生", "牛排",
	...
	return firstName[rand.Intn(len(firstName))] + secondName[rand.Intn(len(secondName))]
}
